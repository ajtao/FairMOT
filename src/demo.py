...
def demo(opt):
    ...
    play_seconds, vid_sec_to_play = get_play_seconds(opt.match_name, opt.view,
                                                     max_plays=opt.max_plays)
    dataloader = datasets.CLoadVideo(input_video, opt.img_size,
                                     play_seconds=play_seconds,
                                     vid_sec_to_play=vid_sec_to_play)
    ...
    d_eval_seq(opt, dataloader, 'vball', result_root, opt.view,
               result_filename, vid_writer=vid_writer,
